...
boston_cocktails <- readr::read_csv('data/boston_cocktails.csv') # Load Boston Cocktail Recipes data set #
...
In this analysis, PC1 and PC2 fail to distinctly separate data points, suggesting a complex or low-variance structure in the dataset. Further exploration of higher-dimensional components may be needed to uncover hidden patterns.
